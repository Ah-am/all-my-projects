...
### [🚕FarePricingPrediction](https://github.com/Ah-am/FarePricingPrediction)  
An intelligent model to predict and forecast fare pricing based on data and real-time variables.  
